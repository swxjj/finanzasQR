...
function BrandQrIcon({ className = 'h-6 w-6', ...props }) {
  return (
    <svg
      ...
      {...props}
    >
      <path fillRule="evenodd" d="M5.5 3A2.5 2.5 0 0 0 3 5.5v3A2.5 2.5 0 0 0 5.5 11h3A2.5 2.5 0 0 0 11 8.5v-3A2.5 2.5 0 0 0 8.5 3h-3zM5 5h4a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H5a.5.5 0 0 1-.5-.5v-3a.5.5 0 0 1 .5-.5zm.75 1.5h2.5v2.5h-2.5z" />
      <rect x="11" y="4" width="2" height="2" rx="0.3" />
      <rect x="11" y="8" width="2" height="3" rx="0.3" />
      <path fillRule="evenodd" d="M16.5 3A2.5 2.5 0 0 0 14 5.5v6.5a2 2 0 0 0 2 2h3a2 2 0 0 0 2-2v-6.5A2.5 2.5 0 0 0 18.5 3h-2zm-.5 2h3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H16a.5.5 0 0 1-.5-.5v-3a.5.5 0 0 1 .5-.5z" />
      ...
      <path fillRule="evenodd" d="M13 17h1v-2h2v4h3a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-5zm3 3h3v2h-3v-2z" />
    </svg>
  )
}
